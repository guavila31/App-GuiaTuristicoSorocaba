...
public class DetalhesLocal02Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalhes_local_02);
        setupRecycler();
        ...
        buttonSite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Uri uri = Uri.parse("https://agendasorocaba.com.br/hangar-51/");
        ...
        buttonMapa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri uri = Uri.parse("geo:0,0?q=R.+Victório+Pegoretti,+51+Jardim+Faculdade");
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        });
    ...
    private void setupRecycler() {
        ...
        */
        ...
        // Definir o Adapter
        fotosLocalAdapter = new FotosLocalAdapter(FotosLocaisDataset.getListaHangar());
